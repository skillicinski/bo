...
- Evaluate a completed run with `BO_EVAL_API_KEY=... python3 evals/evaluate.py evals/results/<run-id>`. The evaluator uses only `BO_EVAL_API_KEY`, never `DEEPSEEK_API_KEY`.
